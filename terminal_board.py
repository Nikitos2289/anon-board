...
# Добавь этот route ПЕРЕД функцией start_server()
@app.route('/')
def home():
    return """
    <html>
    <body style="font-family: Arial; text-align: center; margin-top: 50px;">
        <h1>🌐 Анонимная Борда</h1>
        <p>Сервер работает! Используйте API endpoints:</p>
        <ul style="list-style: none; padding: 0;">
            <li><a href="/api/topics">/api/topics</a> - все темы</li>
            <li>POST /api/create - создать тему</li>
        </ul>
        <p>📱 Для терминального клиента используйте команды меню</p>
    </body>
    </html>
    """
# ================== ЗАПУСК ==================
